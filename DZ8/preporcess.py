...
def prepare(in_dir, pixdim=(1.5, 1.5, 1.0), a_min=-200, a_max=200, spatial_size=[128, 128, 64], cache=True):
    """
    Эта функция предназначена для предварительной обработки, она содержит только базовые преобразования, 
    но вы можете добавить дополнительные операции, которые найдете в документации Monai.
